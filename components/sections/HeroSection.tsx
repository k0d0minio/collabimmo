	...
	return (
		...
		>
			...
			>
				...
				>
					Aucun bien, aucun secteur, aucun défi ne nous arrête.
				</motion.h1>
				<motion.p
					...
					custom={{ duration: duration / 1000 }}
				>
					Bureaux, commerces, entrepôts, terrains à bâtir, agricoles, bois et
					forêts, projets off-market… Dites-nous ce que vous recherchez, nous le
					trouvons pour vous.
				</motion.p>
				<motion.div variants={fadeInUp} custom={{ duration: duration / 1000 }}>
					<CTA size="lg">Parlez-nous de votre projet</CTA>
				</motion.div>
			</motion.div>
		</Section>
	);
