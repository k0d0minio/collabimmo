...
export function getOptimizedVariants(
	...
	const optimized = JSON.parse(JSON.stringify(baseVariants)) as Variants;

	const adjustDuration = (obj: unknown) => {
		if (obj && typeof obj === "object") {
			if (
				"transition" in obj &&
				obj.transition &&
				typeof obj.transition === "object" &&
				"duration" in obj.transition &&
				typeof obj.transition.duration === "number"
			) {
