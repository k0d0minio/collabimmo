...
export const metadata: Metadata = {
	...
	description:
		"Politique de confidentialité de Collabimmo - Découvrez comment nous collectons, utilisons et protégeons vos données personnelles.",
};
				...
				<div className="prose prose-lg max-w-none space-y-6">
					<section>
						...
						<p className="text-gray-700 leading-relaxed">
							...
							Collabimmo collecte, utilise et protège vos informations
					...
					<section>
						...
						<p className="text-gray-700 leading-relaxed">
							...
							directement, notamment lorsque vous remplissez notre formulaire de
							contact. Ces informations peuvent inclure votre nom, adresse
							email, numéro de téléphone, nom de votre entreprise et tout autre
					...
					<section>
						...
						<p className="text-gray-700 leading-relaxed">
							...
							expérience de navigation. Vous pouvez configurer votre navigateur
					...
					<section>
						...
						<p className="text-gray-700 leading-relaxed">
							...
							ou pour exercer vos droits, veuillez nous contacter via le
